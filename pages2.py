...
<section>
  <div class="wrap">
    <div class="section-head reveal"><h2>Eine Garantie, die wir offen kommunizieren.</h2><p style="font-size:15.5px;margin-top:10px;">Wir schaffen Vertrauen durch transparente Konditionen.</p></div>
    <div class="win-grid">
      <div class="win-card reveal">
        <h3>92% bleiben</h3>
        <p>92% unserer vermittelten Fachkräfte bleiben länger als drei Jahre in ihrer Einrichtung.</p>
      </div>
      <div class="win-card reveal" style="transition-delay:.08s">
        <h3>18 Monate kostenlose Nachbesetzung</h3>
        <p>Wird das Arbeitsverhältnis innerhalb der ersten 18 Monate nach Einreise durch die internationale Fachkraft beendet, finden wir für Sie schnell eine Alternative, natürlich ohne zusätzliche Kosten.</p>
      </div>
      <div class="win-card reveal" style="transition-delay:.16s">
        <h3>Zahlung erst bei Erfolg</h3>
        <p>Keine Vorauszahlung. Sie zahlen erst, wenn wir liefern.</p>
      </div>
    </div>
    <p style="font-size:12.5px;color:var(--ink-mute);margin-top:20px;max-width:760px;">Die Nachbesetzungsgarantie gilt bei Eigenkündigung der Fachkraft. Ausgenommen sind Fälle, in denen die Einrichtung selbst kündigt oder die Fachkraft die Stelle aufgrund von Problemen im Arbeitsumfeld verlässt.</p>
  </div>
</section>
